...
void TerrapinProtocolObject::unpack_comm_response(std::vector<uint32_t> msg) {}
...
void TerrapinProtocolObject::sendCommand(int sleeptime,
...
float TerrapinProtocolObject::clip(float n, float lower, float upper) {
